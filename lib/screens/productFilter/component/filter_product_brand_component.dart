...
class _FilterProductBrandComponentState
    extends State<FilterProductBrandComponent> {
            ...
            children: [
              AppTextField(
                ...
                decoration: InputDecoration(
                    label: Text(locale.searchBrand, style: secondaryTextStyle())
                        .paddingLeft(8),
                    ...
                    return Container(
                      ...
                      decoration: boxDecorationDefault(
                        color: appStore.isDarkMode
                            ...
                            : lavender,
                        border: Border.all(
                            color: selectBrandIndex == index
                                ? context.primaryColor
                                : Colors.transparent,
                            width: appStore.isDarkMode ? 2 : 1),
                      ),
                      child: CachedImageWidget(
                          url: brandImageList[index],
                          width: context.width(),
                          height: 35),
                    ).onTap(() {
