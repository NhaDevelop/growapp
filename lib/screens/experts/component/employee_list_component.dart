      ...
      children: [
        Container(
          ...
          child: Column(
            children: [
              Marquee(
                  child: Text(expertData.fullName.validate(),
                      style: boldTextStyle(color: expertNameTextColor),
                      textAlign: TextAlign.center)),
              6.height,
              if (expertData.expert.validate().isNotEmpty)
                Marquee(
                    child: Text(expertData.expert.validate(),
                ...
                child: TextIcon(
                  ...
                  prefix: Icon(Icons.star,
                      ...
                      color: getRatingBarColor(
                          expertData.ratingStar.validate().toInt())),
                ),
              ),
              16.height,
            ],
